     ...
     <div id="page-god">
    	<div class="layout_center">
                        ...
                        <li>
                            <div class="gdx-lists-wrap layout_clear">
                                <div class="gdx-lists-img layout_fl">
                                    <a href="${pageContext.request.contextPath}/toHotelDetails.do?hotelId=${hotel.hotelId}"><img src="${pageContext.request.contextPath}/${hotel.img.imgAdd}" style="display:block"></a>
                                </div>
                                <div class="gdx-lists-data">
                                    <h2>
                                        <a href="${pageContext.request.contextPath}/toHotelDetails.do?hotelId=${hotel.hotelId}" style="font-size: 20px">${hotel.hotelName}</a>
                                    </h2>
                                    <div class="gdx-lists-local">
                                        <span class="page_icon in_local_icon"></span>${hotel.hotelAddress}
                                    </div>
                    ...
                    <li>
                    	<div class="gdx-list-wrap">
                        	<a href="field.html" target="_blank">
                            	<img src="${pageContext.request.contextPath}/img/Yrm54858716fa.jpg" style="width:100%; display:block">
                            </a>
            ...
            <div class="ma_page">
                ...
                <c:if test="${pageInfo.pageNum != 1}">
                    <a href="${pageContext.request.contextPath}/toHotelList.do?currentPage=${pageInfo.pageNum - 1}"><</a>
                </c:if>
                ...
                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum" step="1">
                    ...
                    <c:if test="${pageInfo.pageNum != pageNum}">
                        <a href="${pageContext.request.contextPath}/toHotelList.do?currentPage=${pageNum}">${pageNum}</a>
                    </c:if>
                </c:forEach>
                ...
                <c:if test="${pageInfo.pageNum != pageInfo.pages}">
                    <a class="next" href="${pageContext.request.contextPath}/toHotelList.do?currentPage=${pageInfo.pageNum + 1}">></a>
                </c:if>
